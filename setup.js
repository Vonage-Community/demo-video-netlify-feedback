...
console.log('Enter your GitHub email address:');
...
ALLOWED_GITHUB_USER="${process.env.GITHUB_USER}"
...
function createUser() {
  ...
  privateKey: import.meta.dirname + '/private.key'
  }, {debug: false});
  vonage.users.create({
